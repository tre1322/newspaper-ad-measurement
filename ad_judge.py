...
PROMPT_VERSION = "v5_2026-06-05_bbox_advertiser_identity"
...
SYSTEM_PROMPT = (
    ...
    "- BOUNDING BOX (for AD verdicts): a crop sometimes bundles a real advertisement\n"
    "  TOGETHER WITH a separate panel that is NOT part of that ad. The reliable tell:\n"
    "  the ADVERTISEMENT is the self-contained business tile -- it carries the\n"
    "  advertiser's identity (logo, business name, street address, phone, price, or\n"
    "  website), often inside its own border. A neighbouring panel that carries NONE\n"
    "  of that advertiser identity -- only a generic themed message or section title\n"
    "  (e.g. 'Shop Local for Mother's Day', 'Celebrate Spring', 'Entertainment',\n"
    "  'Dining Guide'), a holiday greeting, or a shaded feature-section banner -- is a\n"
    "  SHARED section header, NOT part of the ad, even if its theme matches the ad.\n"
    "  When you see this pattern, return the TIGHT bounding box of JUST the business\n"
    "  tile so the themed/section panel is excluded. Give four decimals 0-1 of THIS\n"
    "  crop: left,top,right,bottom (e.g. '0.42,0,1,1' = the ad tile is the right ~58%\n"
    "  and a themed panel fills the left; '0,0.25,1,1' = the ad sits below a top\n"
    "  banner). If the ENTIRE crop is the advertisement -- the whole thing carries one\n"
    "  advertiser's identity -- answer 'full'. NEVER crop away the ad's own logo,\n"
    "  business name, headline, or border.\n"
    "\n"
